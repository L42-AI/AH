...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.init_text.grid(row=0, column=0, columnspan=6, padx=10, pady=10, sticky="nsew")

        self.switch_state = 0

        self.malus_switch = customtkinter.CTkCheckBox(master=self.init_text, text="Configure Malus", font=customtkinter.CTkFont(size=15, weight='bold'), command=lambda: self.malus_slider_state(self.switch_state))
        self.malus_switch.grid(row=0, column=6, pady=10, padx=10, sticky="nsew")
