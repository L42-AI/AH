...
if __name__ == '__main__':
    ...
    df = pd.read_csv('One Hillclimber different stages multiplier_4 with greedy.csv')
    ...
    plt.ylabel('Malus')
    plt.title('Experiment Hillclimber Greedy', fontsize=20)

    plt.savefig('Plot Hillclimber Greedy.png', dpi=1000)

    fig = plt.gcf()
    fig.set_size_inches((12, 12), forward=False)
    fig.savefig('Plot Hillclimber Greedy.png', dpi=1000)
