...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        write_to_csv('data/Hillclimber Run for 300 Generatinos Multiplier 4.csv', i, list_iterations, list_total_malus, list_class_random, list_class_capacity, list_student_gaphour, list_student_doublehour, list_duration_since_innit)
